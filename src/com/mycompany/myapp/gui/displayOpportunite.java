 ...
 * @author ASUS
 */
public class displayOpportunite extends BaseForm {

    private static int id_user = 7;

    public displayOpportunite(Resources res) {
        super(BoxLayout.y());
        ...
        ArrayList<Opportunite> list = serviceTask.getMyOpportunities(id_user);
...
//      
        ...
        delete.addActionListener(ee -> {
            ...
            OpportuniteService op = new OpportuniteService();
            op.deleteOpportunite(id);
